...
namespace Hijab.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult PayNow(Order o)
        {
            ...
            Session["Order"] = o;
            if(o.ORDER_STATUS== "Cash On Delievery")
            {
            ...
            {
                return Redirect("https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_xclick&business=fizaakram56@gmail.com&item_name=HijabMartProducts!&return=https://localhost:44327/Home/OrderBooked&amount=" + double.Parse(Session["totalAmount"].ToString()) / 180);
        ...
        public ActionResult OrderBooked()
        {
            ...
            //mail.From = new MailAddress("fizaakram56@gmail.com");
            //mail.To.Add(o.ORDER_EMAIL);
            //mail.Subject = "Order Confirmation";
            //mail.Body = "<b>HijabMart! </b> <br/>Thanks for your order.We will deliver your order within 4 days";
            //mail.IsBodyHtml = true;
            
            //SmtpClient SmtpServer = new SmtpClient("smtp.gmail.com");
            //SmtpServer.Port = 587;
            //SmtpServer.Credentials = new System.Net.NetworkCredential("fizaakram56@gmail.com", "Fiza0169");
            //SmtpServer.EnableSsl = true;
            //SmtpServer.Send(mail);

            ////2.Code for sending sms
            //String api = "https://lifetimesms.com/json?api_token=673889a362f65513f1ba4ebc6ddeb79543c0506907&api_secret=HijabMart&to=" + o.ORDER_CONTACT+ "&from=HijabMart&message=Order Confirmation...";
            //HttpWebRequest req = (HttpWebRequest)WebRequest.Create(api);
            //var httpResponse = (HttpWebResponse)req.GetResponse();


            //3.code for saving order in
            //order & table
            db.Orders.Add(o);
            db.SaveChanges();
